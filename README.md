...
- **Mascotas perdidas/encontradas/heridas** (`/mascotas`, Fase 1 del módulo comunitario de mascotas): reportar en menos de un minuto **sin cuenta** (nombre + correo o celular, foto en el mismo formulario), con la distinción "la vi" vs. "la tengo resguardada" (esta última nunca expone la dirección exacta), estado de ciclo de vida, mapa propio, y pieza para compartir por WhatsApp con cierre automático "🎉 ya volvió a casa". Cambiar el estado requiere cuenta y es comunitario (cualquiera, no solo quien reportó), con rastro en el log de auditoría. **Sin mecanismo de contacto directo todavía** — la reunificación depende de que la pieza compartida circule y llegue a la persona correcta; eso y las confirmaciones comunitarias quedan para Fase 2 ([backend/src/modules/pets/](backend/src/modules/pets/), [frontend/src/pages/PetsPage.tsx](frontend/src/pages/PetsPage.tsx))
